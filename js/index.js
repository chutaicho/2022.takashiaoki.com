const HeaderElement = `
    <div class='twelve columns' style='margin-top: 10%'>
        ...
        <a href='https://www.linkedin.com/in/chutaicho/'>Linkedin</a> / 
        <a href='https://www.instagram.com/chutaicho/'>Instagram</a> / 
        <a href='https://archive.takashiaoki.com/'>Archive</a>
        <br><br>
    </div>
`;
